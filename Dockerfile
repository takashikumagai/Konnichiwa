...
RUN cd /app && pip install --cache-dir=/tmp/pip-cache .

#RUN ls -lha /home/$SERVICE_NAME/.local/bin/

WORKDIR /app/src/api

# Run uvicorn as $SERVICE_NAME
CMD ["/home/konnichiwa/.local/bin/uvicorn", "main:app", "--host", "0.0.0.0", "--port", "80"]
